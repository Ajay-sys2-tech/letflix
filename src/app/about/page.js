...
export default function () {
  return (
    <div className='max-w-6xl mx-auto p-3 space-y-4'>
        ...
        <p>
            As an additional incentive for users, as of 2003, users identified as one of the "top 100 contributors" of 
            hard data received complimentary free access to IMDbPro for the following calendar year; for 2006 this was 
        ...
        <p>
            ...
            process; this usually takes between 24 and 72 hours.
        </p>
